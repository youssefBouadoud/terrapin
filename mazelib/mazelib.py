...
def set_seed(seed: int | float | str | bytes | bytearray | None = None) -> None:
...
class Maze:
    ...
    def __init__(self, seed=None) -> None:
        self.generator = None
        self.grid = None
        self.start: list | None = None
        self.end: list | None = None
        self.solver = None
    ...
    def generate(self) -> None:
        ...
        ), "No maze-generator algorithm has been set."
    ...
    def generate_entrances(self, start_outer: bool = True, end_outer: bool = True) -> None:
    ...
    def _generate_outer_entrances(self) -> None:
        """Generate maze entrances, along the outer walls.
    ...
    def _generate_inner_entrances(self) -> None:
    ...
    def _generate_opposite_entrances(self) -> tuple:
    ...
    def tostring(self, entrances=False, solutions=False, nl=True):
